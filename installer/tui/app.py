...
class VulcanApp(App):
    ...
    def __init__(self) -> None:
        ...
        # The whiptail/DockSTARTer-style theme + the Checkbox/RadioSet
        # width+background CSS fix, both extracted into the shared
        # `smithy` package after being tuned and screenshot-verified
        # here first - see smithy's own CLAUDE.md/README for the full
        # design history (the theme itself, and the real live-found
        # auto-width layout gotcha the CSS fix closes).
