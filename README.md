...
Pick exactly which of the 43 known services to include, regardless of tier, pre-checked based on your hardware — service keys come from the [Services Catalog](docs/services-catalog.md):
