...
**Custom mode** lets you pick exactly which services to include, from all 14 known services regardless of tier, pre-checked based on what your hardware qualifies for:
