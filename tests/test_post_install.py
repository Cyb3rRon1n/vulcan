...
def test_verify_stack_running_all_healthy_ndjson():
    ...
    ndjson = (
        '{"Name":"jellyfin","Service":"jellyfin","State":"running","Status":"Up 2 minutes"}\n'
        '{"Name":"radarr","Service":"radarr","State":"running","Status":"Up 2 minutes (healthy)"}\n'
    )
...
def test_verify_stack_running_detects_crashed_container_json_array():
    ...
    array = (
        '[{"Name":"jellyfin","Service":"jellyfin","State":"running","Status":"Up 2 minutes"},'
        '{"Name":"radarr","Service":"radarr","State":"exited","Status":"Exited (1) 5 seconds ago"}]'
    )
    ...
    assert result == {
        ...
        "error": None,
        "not_running": [
            {"service": "radarr", "state": "exited", "status": "Exited (1) 5 seconds ago"}
        ]
    }
